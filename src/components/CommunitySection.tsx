            ...
            {eventosComunidad.map((evento) => (
              ...
              >
                <div className="mb-4 flex items-start justify-between">
                  <div>
                    <h4 className="mb-1 text-lg text-gray-900">{evento.title}</h4>
                  ...
                  <div className="flex gap-1">
                    {evento.petTypes.map((pet) => (
                      <span key={`${evento.id}-${pet}`} className="text-lg">
                        {pet}
                      </span>
                    ))}
                  </div>
                ...
                <div className="mb-4">
                  <div className="h-2 w-full rounded-full bg-gray-200">
                    <div
                      ...
                      style={{ width: `${(evento.attendees / evento.maxAttendees) * 100}%` }}
                    />
                  </div>
                </div>
